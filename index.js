...
//const finalname = fifaData.filter((fifaData) => {
//return fifaData.Year == 2014 && fifaData.Stage == "Final"
//
//

//console.log(finalname[0]['Home Team Name'])
//(b) 2014 Dünya kupası Finali Deplasman takım ismi  (dizide "Away Team Name" anahtarı)
//console.log(finalname[0]['Away Team Name'])
//(c) 2014 Dünya kupası finali Ev sahibi takım golleri (dizide "Home Team Goals" anahtarı)
//console.log(finalname[0]['Home Team Goals'])
//(d)2014 Dünya kupası finali Deplasman takım golleri  (dizide "Away Team Goals" anahtarı)
//console.log(finalname[0]['Away Team Goals'])
...
function Yillar(fifaData, Finaller) {
  const Yillar = Finaller(fifaData).map((match) => {
    return match["Year"];
  });
  return Yillar;
}
...
function OrtalamaGolSayisi(Finaller) {
  const toplamgolsayisi = Finaller.reduce(
    (toplamgol, match) =>
